(function($){
    ...
    /* jsSpMenu
    --------------------------------------------------*/
    var jsSpMenu = function(){
        $('.has-sub').each(function(index){
            $(this).append('<span class="is-btn is-hide"></span>');
        });
        $('.is-btn').each(function(){
            $(this).on('click',function(){
                ...
                // }
                $(this).toggleClass('is-hide is-show');           
            });
        });
    }
    ...
    if($('.structure-manager .structure-list').length){
        $(".structure-manager .structure-list").slick({
            slidesToShow: 3,
            slidesToScroll: 1,
            dots: false,
            autoplay: true,
